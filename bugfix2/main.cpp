...
int main(){
    ...
    ScoreControl scorecontrol(OLEDterminal, lives, shootcontrol);

    TimeControl timecontrol(OLEDterminal, gametime, lives, scorecontrol, shootcontrol);
    ...
    LeaderControl leadercontrol(gametime, OLEDterminal, irmessagecontrol, terminal);
